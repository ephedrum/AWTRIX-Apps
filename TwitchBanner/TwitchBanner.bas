...
Public Sub Initialize() As String
	...
	<b>Username</b>  Insert your Twitch channel info<br />
	...
	App.Settings=CreateMap("Username":"Twitch Channel", "IconID":1526)
